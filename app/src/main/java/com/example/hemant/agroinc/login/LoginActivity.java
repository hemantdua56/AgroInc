package com.example.hemant.agroinc.login;
...
import com.example.hemant.agroinc.SuperMainActivity;
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    if (firstTimeAccess) {
                        startActivity(new Intent(LoginActivity.this, SuperMainActivity.class));
