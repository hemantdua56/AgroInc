package com.example.hemant.agroinc.cropInformation;
...
public class AgricultureLib extends AppCompatActivity {
    ...
    private void createDummyData() {
            ...
            singleItemModelPulses.add(new SingleItemModel("moong", "b","c","d","E","f6",R.drawable.ic_launcher_foreground));
            singleItemModelPulses.add(new SingleItemModel("masar", "b","c","d","E","f6",R.drawable.ic_launcher_foreground));
            singleItemModelPulses.add(new SingleItemModel("beans", "b","c","d","E","f6",R.drawable.ic_launcher_foreground));
            ...
            singleItemModelFruits.add(new SingleItemModel("apple", "b","c","d","E","f6",R.drawable.ic_launcher_foreground));
            singleItemModelFruits.add(new SingleItemModel("orange", "b","c","d","E","f6",R.drawable.ic_launcher_foreground));
            singleItemModelFruits.add(new SingleItemModel("papaya", "6-7.5","c","d","E","f6",R.drawable.ic_launcher_foreground));
        ...
        singleItemModelCereals.add(new SingleItemModel("rice", "b","c","d","E","f6",R.drawable.ic_launcher_foreground));
        singleItemModelCereals.add(new SingleItemModel("maize", "b","c","d","E","f6",R.drawable.ic_launcher_foreground));
        singleItemModelCereals.add(new SingleItemModel("barley", "b","c","d","E","f6",R.drawable.ic_launcher_foreground));
        singleItemModelCereals.add(new SingleItemModel("millet", "6-7.5","c","d","E","f6",R.drawable.ic_launcher_foreground));
        ...
        singleItemModelVegetables.add(new SingleItemModel("ladyfinger", "b","c","d","E","f6",R.drawable.ic_launcher_foreground));
        singleItemModelVegetables.add(new SingleItemModel("brinjal", "6-7.5","c","d","E","f6",R.drawable.ic_launcher_foreground));
        ...
        singleItemModelSpecies.add(new SingleItemModel("ginger", "b","c","d","E","f6",R.drawable.ic_launcher_foreground));
        singleItemModelSpecies.add(new SingleItemModel("cinnamon", "b","c","d","E","f6",R.drawable.ic_launcher_foreground));
        singleItemModelSpecies.add(new SingleItemModel("turmeric", "6-7.5","c","d","E","f6",R.drawable.ic_launcher_foreground));
        ...
        singleItemModelFibre.add(new SingleItemModel("tobacco", "b","c","d","E","f6",R.drawable.ic_launcher_foreground));
        singleItemModelFibre.add(new SingleItemModel("bamboo", "6-7.5","c","d","E","f6",R.drawable.ic_launcher_foreground));
